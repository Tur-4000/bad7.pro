...
<div class="form-group">
    ...
    {{ Form::textarea('description', null, ['class' => 'form-control', 'rows' => 3, 'aria-describedby' => 'descriptionHelp', 'required' => 'required']) }}
    <small id="descriptionHelp" class="form-text text-muted">Описание услуги.</small>
</div>

<div class="form-group">
    {{ Form::label('description_ext', 'Развернутое описание') }}
    {{ Form::textarea('description_ext', null, ['class' => 'form-control', 'rows' => 3, 'aria-describedby' => 'descriptioextnHelp']) }}
